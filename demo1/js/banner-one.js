...
$(function(){
    ...
    for(var i=0;i<parseInt(Big_Slide_liNubr);i++){
        ...
        if(i==1){
            Big_Slide_Tab_Contne=Big_Slide_Tab_Contne+"<a class='"+"TabOn' id='"+"TabOn"+i+"' style='width:"+Big_Slide_Tab_AWidth+"px'></a>";
            }else{
                Big_Slide_Tab_Contne=Big_Slide_Tab_Contne+"<a id='TabOn"+i+"' style='width:"+Big_Slide_Tab_AWidth+"px'></a>";//生成tab按钮
                }
        }
